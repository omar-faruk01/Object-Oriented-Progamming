...
int main()
{
	...
	ptrNAq = new NAquestion("When Michael Jordan played for the Chicago Bulls, how many NBA Championships did he win?", 5, 8, 15); // Question 2
	...
	cout << "Question with the largest value: \n";
	cout << NumericExam.largestQuestion()->getText() << endl;
